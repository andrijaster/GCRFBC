...
for train_index,test_index in skf.split(atribute, output):
    ...
    mod41.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = iteracija,method_clus = 'KMeans', clus_no = 500)  
...
#    mod42.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 5000,method_clus = 'KMeans', clus_no = 2500)  
...
#    timeBF22[i] = time.time() - start_time
    ...
    mod61.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = iteracija,method_clus = 'MiniBatchKMeans', clus_no = 500)  
...
#    mod62.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 5000,method_clus = 'MiniBatchKMeans', clus_no = 2500)  
...
#    timeBF42[i] = time.time() - start_time
    ...
    mod81.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = iteracija,method_clus = 'GaussianMixture', clus_no = 500)  
...
#    mod82 = GCRFC_fast()
#    #x0 = np.load('mod81.npy')
#    mod82.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 5000,method_clus = 'GaussianMixture', clus_no = 2500)  
...
#    timeBF62[i] = time.time() - start_time
    ...
    mod101.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = iteracija,method_clus = 'GaussianMixtureProb', clus_no = 500)  
...
#    mod102.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 5000,method_clus = 'GaussianMixtureProb', clus_no = 2500)  
