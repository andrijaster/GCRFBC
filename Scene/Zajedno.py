...
from Scene_dataset import output, atribute
...
file = open("rezultatiSCENE.txt","w")
...
for train_index,test_index in skf.split(atribute, output):
    ...
    mod1 = GCRFCNB()
    mod1.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 6e-4, maxiter = 200)  
    ...
    mod2 = GCRFC()
    #x0 = np.load('mod2.npy')
    mod2.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200)  
    np.save('mod2',mod2.x)  
    ...
    mod3 = GCRFC_fast()
    #x0 = np.load('mod3.npy')
    mod3.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200, method_clus = 'KMeans', clus_no = 5)  
    np.save('mod3',mod3.x)
    ...
    mod4 = GCRFC_fast()
    #x0 = np.load('mod4.npy')
    mod4.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'KMeans', clus_no = 50)  
    np.save('mod4',mod4.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod41.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'KMeans', clus_no = 500)  
    ...
    mod42.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'KMeans', clus_no = 1200)  
    ...
    mod5 = GCRFC_fast()
    #x0 = np.load('mod5.npy')
    mod5.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'MiniBatchKMeans', clus_no = 5)  
    np.save('mod5',mod5.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod6 = GCRFC_fast()
    #x0 = np.load('mod6.npy')
    mod6.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'MiniBatchKMeans', clus_no = 50)  
    np.save('mod6',mod6.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod61.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'MiniBatchKMeans', clus_no = 500)  
    ...
    mod62.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'MiniBatchKMeans', clus_no = 1200)  
    ...
    mod7 = GCRFC_fast()
    #x0 = np.load('mod7.npy')
    mod7.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixture', clus_no = 5)  
    np.save('mod7',mod7.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod8 = GCRFC_fast()
    #x0 = np.load('mod8.npy')
    mod8.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixture', clus_no = 50)  
    np.save('mod8',mod8.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod81.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixture', clus_no = 500)  
    ...
    mod82 = GCRFC_fast()
    #x0 = np.load('mod81.npy')
    mod82.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixture', clus_no = 1200)  
    ...
    mod9 = GCRFC_fast()
    #x0 = np.load('mod9.npy')
    mod9.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixtureProb', clus_no = 5)  
    np.save('mod9',mod9.x)
    #mod1.alfa = np.array([0.1043126 , 0.06905401, 0.08689079])
    #mod1.beta = np.array([1.00008728e-08, 2.88191498e+02, 1.00000563e-08, 1.00000000e-08, 8.74943190e+01, 3.48984028e-03])  
    ...
    mod10.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixtureProb', clus_no = 50)  
    ...
    mod101.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixtureProb', clus_no = 500)  
    ...
    mod102.fit(R_train, Se_train, Y_train, learn = 'TNC', learnrate = 3e-4, learnratec = 0.5, maxiter = 200,method_clus = 'GaussianMixtureProb', clus_no = 1200)  
