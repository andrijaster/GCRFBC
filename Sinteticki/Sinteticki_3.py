...
NoModelUN = 2
NoGraph = 2
NodeNo = np.array([25, 50, 100, 200, 500, 1000, 1500])
Noinst = 10
duzina = len(NodeNo)
...
for i in NodeNo:
    ...
    R = np.random.rand(Noinst*i,NoModelUN)*2-1
...
plt.savefig('Synthetic_3.pdf')
plt.savefig('Synthetic_3.png')
